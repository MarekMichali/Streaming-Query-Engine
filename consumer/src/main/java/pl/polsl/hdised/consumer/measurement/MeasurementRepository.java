...
public interface MeasurementRepository extends JpaRepository<MeasurementEntity, Long> {
    ...
    @Query(value = "SELECT MIN(temperature) as averageTemperature\n" +
            ...
            "location.city = :location AND\n" +
            "date.scan_date BETWEEN :startDate AND :finishDate", nativeQuery = true)
    Float getMinimumTemperature(@Param("deviceId") String deviceId, @Param("location") String location, @Param("startDate") Date startDate, @Param("finishDate") Date finishDate);

    @Query(value = "SELECT MAX(temperature) as averageTemperature\n" +
            "FROM measurement \n" +
            "join device on measurement.device_id = device.id\n" +
            "join location on measurement.location_id = location.id\n" +
            "join date on measurement.scan_date_id = date.id\n" +
            ...
            "location.city = :location AND\n" +
            "date.scan_date BETWEEN :startDate AND :finishDate", nativeQuery = true)
    Float getMaximumTemperature(@Param("deviceId") String deviceId, @Param("location") String location, @Param("startDate") Date startDate, @Param("finishDate") Date finishDate);

    @Query(value = "SELECT temperature as temperature, date.scan_date as date\n" +
            "FROM measurement \n" +
            "join device on measurement.device_id = device.id\n" +
            "join location on measurement.location_id = location.id\n" +
            "join date on measurement.scan_date_id = date.id\n" +
            ...
            "location.city = :location AND\n" +
            "date.scan_date BETWEEN :startDate AND :finishDate", nativeQuery = true)
    List<Tuple> getAllTemperatures(@Param("deviceId") String deviceId, @Param("location") String location, @Param("startDate") Date startDate, @Param("finishDate") Date finishDate);
